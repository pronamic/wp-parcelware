<h3><?php _e('Parcelware Order Exporter', 'parcelware-plugin'); ?></h3>

<form method="post" action="<?php echo $form_action; ?>">
	<table class="wide-fat">
		<tr>
			<td><?php _e('Date from', 'parcelware-plugin'); ?></td>
			<td><input type="text" id="date-from" name="date-from" value="<?php echo $datetime_today; ?>" /></td>
		</tr>
		<tr>
			<td><?php _e('Date to', 'parcelware-plugin'); ?></td>
		...
		<tr>
			...
			<td><label for="skip-already-exported"><?php _e('Skip orders that have already been exported.', 'parcelware-plugin'); ?></label></td>
		</tr>
	</table>
	<?php submit_button( __('Download CSV File', 'parcelware-plugin') ); ?>
</form>
